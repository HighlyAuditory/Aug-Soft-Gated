...
def main():
    ...
    for i, data in enumerate(dataset):
        ...
        test_list = [('b_label_show', util.tensor2im(b_label_show_tensor[0])),
                      ('a_parsing_tensor', util.parsing2im(util.label_2_onhot(a_parsing_tensor[0], parsing_label_nc=opt.parsing_label_nc))),
                      ('fake_b_parsing', util.parsing2im(fake_b_parsing.data[0])),
                      ('b_parsing_tensor', util.parsing2im(util.label_2_onhot(b_parsing_tensor[0], parsing_label_nc=opt.parsing_label_nc)))]
