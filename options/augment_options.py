...
class AugmentOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--beta2', type=float, default=0.5, help='momentum term of adam for augment network')
        self.parser.add_argument('--lr', type=float, default=0.0002, help='initial learning rate for adam')
        self.parser.add_argument('--lr2', type=float, default=0.0002, help='initial learning rate for augment network')
